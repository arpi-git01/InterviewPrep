...
public class BreadthFirstSearch {
	...
	public static void main(String[] args){
		...
		LinkedList<Object> ll = new LinkedList<Object>(); //LL to save path
		ll = bfs.getLLBFSPath(m,"E",ll); //saves path in LL
		bfs.printBFSPath(ll); //prints path from LL	
	}
	
	/**
	 * @ABOUT gets the bfs path from the hashmap<Vertex,from>
	 */
	...
	/**
	 * @ABOUT gets the bfs path from the hashmap<Vertex,from> and saves it in linked list
	 */
	...
	/**
	 * @ABOUT prints the bfs path from LL
	 */
