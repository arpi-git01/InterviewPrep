...
public class Palindrome {
	 ...
	 * @return true: is a Palindrome, false: not a Palindrome
	 */
	...
	public boolean checkPalindromeRev(String str){
		...
		if(str.equals(reverse.toString())) {return true;}
		else return false;
	}
	...
	public static void main(String args[]){
		...
		for(String s: input){
			System.out.println(s+" is Palindrome? "+p.checkPalindromeRecurse(s));
			System.out.println(s+" is Palindrome? "+p.checkPalindromeIter(s));
			System.out.println(s+" is Palindrome? "+p.checkPalindromeRev(s));
		}
	}
}
